...
| job.timeSlot.timeSlotStart | NO | The start time of the timeSlot - If none given then value should be 'TBC' |
| job.timeSlot.timeSlotEnd | NO | The end time of the timeSlot - If none given then value should be 'TBC'|
